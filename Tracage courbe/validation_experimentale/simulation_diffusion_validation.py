...
k = 0.18             # conductivité thermique en W/(m.K)

# Conditions initiales et aux limites
T_initial = 23    # température initiale (°C)
...
# Affichage de l'évolution de la température au cours du temps
plt.figure(figsize=(8, 5))
plt.plot(time, T_chaud)
plt.xlabel("Temps (s)")
plt.ylabel("Température à d = 3,5cm")
plt.title("Évolution intérieur de la température")
plt.grid(True)
# %%
releve_chaud = open("relevé_chaud.csv","r",encoding="latin-1")
releve_milieu = open("relevé_milieu.csv","r",encoding="latin-1")
releve_froid = open("relevé_froid.csv","r",encoding="latin-1")
...
# %%
plt.figure(figsize=(8, 5))
plt.plot(temps,T_chaud_exp)
plt.plot(time, T_chaud)
plt.xlabel("Temps (s)")
plt.ylabel("Température coté chaud")
plt.title("Évolution intérieur de la température")
plt.grid(True)
plt.show()

plt.figure(figsize=(8, 5))
plt.plot(temps,T_froid_exp)
plt.plot(time, T_froid)
plt.xlabel("Temps (s)")
plt.ylabel("Température coté froid")
plt.title("Évolution intérieur de la température")
plt.grid(True)
plt.show()

plt.figure(figsize=(8, 5))
plt.plot(temps,T_milieu_exp)
plt.plot(time, T_milieux)
plt.xlabel("Temps (s)")
plt.ylabel("Température coté froid")
plt.title("Évolution intérieur de la température")
plt.grid(True)
